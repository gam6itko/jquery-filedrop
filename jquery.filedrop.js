 ...
 *
 *  GAM6ITKO CUSTOM https://github.com/gam6itko/jquery-filedrop
 */
;
(function ($) {
    ...
    $.fn.filedrop = function (options) {
        ...
        function upload() {
                ...
                try {
                    if (beforeEach(_files[fileIndex]) !== false) {
                        ...
                        var reader = new FileReader(),
                            max_file_size = 1048576 * _opts.maxfilesize; //1048576 B == 1 MB
            ...
            var send = function (e) {
                ...
                if (jQuery.isFunction(_opts.url)) {
                    xhr.open(_opts.requestType, _opts.url(), true);
                } else {
                    xhr.open(_opts.requestType, _opts.url, true);
                }
